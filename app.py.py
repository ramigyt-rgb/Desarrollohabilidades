...
# Mantener la navegación lateral disponible también durante el setup inicial.
# Si todavía no hay habilidad activa, usamos una habilidad temporal solo para
# renderizar el sidebar sin alterar el perfil del usuario.
if not profile.get("active_skill"):
    temp_profile = dict(profile)
    temp_profile["active_skill"] = "Aviación"
